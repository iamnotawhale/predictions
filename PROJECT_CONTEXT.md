...
- Mini App кубки: цвета турниров на карточках; категория «Кубки» (карточки турниров, только матчи **на сегодня** + live); live-детали/составы/комментарии через ESPN summary по league slug; live Общий зачёт += provisional cup.
