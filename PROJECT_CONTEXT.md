...
- Mini App кубки: цвета турниров на карточках; категория «Кубки» (карточки турниров, матчи с сегодня и будущие + FT за последние 2 дня); live-детали/составы/комментарии через ESPN summary по league slug; live Общий зачёт += provisional cup.
