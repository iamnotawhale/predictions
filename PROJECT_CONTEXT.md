...
- Матрица Пуассона 0–5 с мягкими весами BTTS/CS/FTS/ничьи/Over-Under (проценты FootyStats всегда `/100`).
- Нормализованные вероятности 1/X/2 из букмекерских коэффициентов слегка сдвигают λ и итоговый выбор счёта.
